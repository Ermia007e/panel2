    ...
    return (
        ...
        >
            <div ref={modalContentRef}>
                ...
                >
                    {title}
                    <Button close className="position-relative" onClick={toggle} style={darkMode ? darkCloseButton : {}} />
                </ModalHeader>
        ...
        >
            ...
            >
                {({ errors, touched, isSubmitting }) => (
                    <Form>
                        <div className="mb-3">
                            <Label for="depName" style={darkMode ? darkLabelStyle : {}}>نام دپارتمان</Label>
                            <Field
                                name="depName"
                                as={Input}
                        ...
                        <div className="mb-3">
                            <Label for="buildingId" style={darkMode ? darkLabelStyle : {}}>شناسه ساختمان</Label>
                            <Field
                                name="buildingId"
                                as={Input}
                                type="number"
