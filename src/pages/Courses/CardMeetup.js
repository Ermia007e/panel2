    ...
    <Card className='card-developer-meetup'>
      ...
      <CardBody>
        ...
        <div className='d-flex'>
          ...
          <div>
            <h6 className='mb-0'>نام استاد : </h6>
        ...
        <div className='d-flex mt-2'>
          <Avatar color='light-primary' className='rounded me-1' icon={<MapPin size={18} />} />
          <div>
            <h6 className='mb-0'>وضعیت دوره :</h6>
            <small>Manhattan, New york City</small>
          </div>
        </div>
        ...
        <div className='d-flex mt-2'>
          <Avatar color='light-primary' className='rounded me-1' icon={<MapPin size={18} />} />
          <div>
            <h6 className='mb-0'>قیمت دوره :</h6>
            <small>Manhattan, New york City</small>
          </div>
        </div>
        ...
        <div className='d-flex mt-2'>
          <Avatar color='light-primary' className='rounded me-1' icon={<MapPin size={18} />} />
          <div>
            <h6 className='mb-0'>شروع دوره :</h6>
            <small>Manhattan, New york City</small>
          </div>
        </div>
        ...
        <div className='d-flex mt-2'>
          <Avatar color='light-primary' className='rounded me-1' icon={<MapPin size={18} />} />
          <div>
            <h6 className='mb-0'>پایان دوره :</h6>
            <small>Manhattan, New york City</small>
          </div>
        </div>
