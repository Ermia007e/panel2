...
function _2({ row: t3, expanded: n2 = false, expandableIcon: o2, id: a2, onToggled: l3, disabled: r3 = false }) {
  return e2.createElement(A, { onClick: (e3) => e3.stopPropagation(), $noPadding: true }, e2.createElement(M2, { id: a2, row: t3, expanded: n2, expandableIcon: o2, disabled: r3, onToggled: l3 }));
}
...
function q2({ columns: t3 = [], conditionalRowStyles: n2 = [], defaultExpanded: o2 = false, defaultExpanderDisabled: a2 = false, dense: l3 = false, expandableIcon: i3, expandableRows: s3 = false, expandableRowsComponent: d3, expandableRowsComponentProps: c3, expandableRowsHideExpander: g3, expandOnRowClicked: b3 = false, expandOnRowDoubleClicked: m3 = false, highlightOnHover: w3 = false, id: f2, expandableInheritConditionalStyles: x3, keyField: C3, onRowClicked: y3 = u2, onRowDoubleClicked: R3 = u2, onRowMouseEnter: v3 = u2, onRowMouseLeave: S3 = u2, onRowExpandToggled: E3 = u2, onSelectedRow: O3 = u2, pointerOnHover: $3 = false, row: k3, rowCount: P2, rowIndex: D3, selectableRowDisabled: F3 = null, selectableRows: j3 = false, selectableRowsComponent: I3, selectableRowsComponentProps: L3, selectableRowsHighlight: M3 = false, selectableRowsSingle: A2 = false, selected: N3, striped: B3 = false, draggingColumnId: G3, onDragStart: V3, onDragOver: U3, onDragEnd: Y3, onDragEnter: q3, onDragLeave: J3 }) {
  ...
  const Z3 = e2.useCallback(() => {
    ...
    S3(k3, e3);
  }, [S3, k3]), le3 = r2(k3, C3), { conditionalStyle: re3, classNames: ie3 } = p(k3, n2, ["rdt_TableRow"]), se3 = M3 && N3, de3 = x3 ? re3 : {}, ce3 = B3 && D3 % 2 == 0;
  return e2.createElement(e2.Fragment, null, e2.createElement(K2, { id: `row-${f2}`, role: "row", $striped: ce3, $highlightOnHover: w3, $pointerOnHover: !a2 && ee3, $dense: l3, onClick: te3, onDoubleClick: ne3, onMouseEnter: oe3, onMouseLeave: ae3, className: ie3, $selected: se3, $conditionalStyle: re3 }, j3 && e2.createElement(T2, { name: `select-row-${le3}`, keyField: C3, row: k3, rowCount: P2, selected: N3, selectableRowsComponent: I3, selectableRowsComponentProps: L3, selectableRowDisabled: F3, selectableRowsSingle: A2, onSelectedRow: O3 }), s3 && !g3 && e2.createElement(_2, { id: le3, expandableIcon: i3, expanded: Q3, row: k3, onToggled: Z3, disabled: a2 }), t3.map((t4) => t4.omit ? null : e2.createElement(H2, { id: `cell-${t4.id}-${le3}`, key: `cell-${t4.id}-${le3}`, dataTag: t4.ignoreRowClick || t4.button ? null : W2, column: t4, row: k3, rowIndex: D3, isDragging: h(G3, t4.id), onDragStart: V3, onDragOver: U3, onDragEnd: Y3, onDragEnter: q3, onDragLeave: J3 }))), s3 && Q3 && e2.createElement(z2, { key: `expander-${le3}`, data: k3, extendedRowStyle: de3, extendedClassNames: ie3, ExpanderComponent: d3, expanderComponentProps: c3 }));
}
...
var Xe = e2.memo(function(t3) {
  const { data: n2 = ke2.data, columns: o2 = ke2.columns, title: i3 = ke2.title, actions: s3 = ke2.actions, keyField: d3 = ke2.keyField, striped: u3 = ke2.striped, highlightOnHover: p2 = ke2.highlightOnHover, pointerOnHover: m3 = ke2.pointerOnHover, dense: h2 = ke2.dense, selectableRows: f2 = ke2.selectableRows, selectableRowsSingle: C3 = ke2.selectableRowsSingle, selectableRowsHighlight: v3 = ke2.selectableRowsHighlight, selectableRowsNoSelectAll: S3 = ke2.selectableRowsNoSelectAll, selectableRowsVisibleOnly: E3 = ke2.selectableRowsVisibleOnly, selectableRowSelected: O3 = ke2.selectableRowSelected, selectableRowDisabled: k3 = ke2.selectableRowDisabled, selectableRowsComponent: P2 = ke2.selectableRowsComponent, selectableRowsComponentProps: D3 = ke2.selectableRowsComponentProps, onRowExpandToggled: H3 = ke2.onRowExpandToggled, onSelectedRowsChange: F3 = ke2.onSelectedRowsChange, expandableIcon: j3 = ke2.expandableIcon, onChangeRowsPerPage: I3 = ke2.onChangeRowsPerPage, onChangePage: T3 = ke2.onChangePage, paginationServer: L3 = ke2.paginationServer, paginationServerOptions: M3 = ke2.paginationServerOptions, paginationTotalRows: A2 = ke2.paginationTotalRows, paginationDefaultPage: _3 = ke2.paginationDefaultPage, paginationResetDefaultPage: N3 = ke2.paginationResetDefaultPage, paginationPerPage: z3 = ke2.paginationPerPage, paginationRowsPerPageOptions: W3 = ke2.paginationRowsPerPageOptions, paginationIconLastPage: B3 = ke2.paginationIconLastPage, paginationIconFirstPage: G3 = ke2.paginationIconFirstPage, paginationIconNext: V3 = ke2.paginationIconNext, paginationIconPrevious: U3 = ke2.paginationIconPrevious, paginationComponent: Y3 = ke2.paginationComponent, paginationComponentOptions: K3 = ke2.paginationComponentOptions, responsive: J3 = ke2.responsive, progressPending: Q3 = ke2.progressPending, progressComponent: X3 = ke2.progressComponent, persistTableHead: Z3 = ke2.persistTableHead, noDataComponent: ee3 = ke2.noDataComponent, disabled: te3 = ke2.disabled, noTableHead: oe3 = ke2.noTableHead, noHeader: le3 = ke2.noHeader, fixedHeader: re3 = ke2.fixedHeader, fixedHeaderScrollHeight: ie3 = ke2.fixedHeaderScrollHeight, pagination: se3 = ke2.pagination, subHeader: de3 = ke2.subHeader, subHeaderAlign: ce3 = ke2.subHeaderAlign, subHeaderWrap: ge3 = ke2.subHeaderWrap, subHeaderComponent: ue3 = ke2.subHeaderComponent, noContextMenu: be3 = ke2.noContextMenu, contextMessage: me3 = ke2.contextMessage, contextActions: he3 = ke2.contextActions, contextComponent: Se3 = ke2.contextComponent, expandableRows: Ee3 = ke2.expandableRows, onRowClicked: Oe3 = ke2.onRowClicked, onRowDoubleClicked: $e2 = ke2.onRowDoubleClicked, onRowMouseEnter: Pe3 = ke2.onRowMouseEnter, onRowMouseLeave: De3 = ke2.onRowMouseLeave, sortIcon: He3 = ke2.sortIcon, onSort: Fe3 = ke2.onSort, sortFunction: je3 = ke2.sortFunction, sortServer: Ie3 = ke2.sortServer, expandableRowsComponent: Te3 = ke2.expandableRowsComponent, expandableRowsComponentProps: Ae3 = ke2.expandableRowsComponentProps, expandableRowDisabled: _e3 = ke2.expandableRowDisabled, expandableRowsHideExpander: Ne3 = ke2.expandableRowsHideExpander, expandOnRowClicked: ze3 = ke2.expandOnRowClicked, expandOnRowDoubleClicked: We2 = ke2.expandOnRowDoubleClicked, expandableRowExpanded: Be3 = ke2.expandableRowExpanded, expandableInheritConditionalStyles: Ge3 = ke2.expandableInheritConditionalStyles, defaultSortFieldId: Ve3 = ke2.defaultSortFieldId, defaultSortAsc: Ue3 = ke2.defaultSortAsc, clearSelectedRows: Ke2 = ke2.clearSelectedRows, conditionalRowStyles: Je2 = ke2.conditionalRowStyles, theme: Xe2 = ke2.theme, customStyles: Ze = ke2.customStyles, direction: et = ke2.direction, onColumnOrderChange: tt = ke2.onColumnOrderChange, className: nt, ariaLabel: ot } = t3, { tableColumns: at, draggingColumnId: lt, handleDragStart: rt, handleDragEnter: it, handleDragOver: st, handleDragLeave: dt, handleDragEnd: ct, defaultSortDirection: gt, defaultSortColumn: ut } = Qe(o2, tt, Ve3, Ue3), [{ rowsPerPage: pt, currentPage: bt, selectedRows: mt, allSelected: ht, selectedCount: wt, selectedColumn: ft, sortDirection: xt, toggleOnSelectedRowsChange: Ct }, yt] = e2.useReducer(w2, { allSelected: false, selectedCount: 0, selectedRows: [], selectedColumn: ut, toggleOnSelectedRowsChange: false, sortDirection: gt, currentPage: _3, rowsPerPage: z3, selectedRowsFlag: false, contextMessage: ke2.contextMessage }), { persistSelectedOnSort: Rt = false, persistSelectedOnPageChange: vt = false } = M3, St = !(!L3 || !vt && !Rt), Et = se3 && !Q3 && n2.length > 0, Ot = Y3 || Le2, $t = e2.useMemo(() => ((e3 = {}, t4 = "default", n3 = "default") => {
    ...
    var a2;
  })(Ze, Xe2), [Ze, Xe2]), kt = e2.useMemo(() => Object.assign({}, "auto" !== et && { dir: et }), [et]), Pt = e2.useMemo(() => {
    if (Ie3)
      return n2;
    ...
    }(n2, null == ft ? void 0 : ft.selector, xt, je3);
  }, [Ie3, ft, xt, n2, je3]), Dt = e2.useMemo(() => {
    if (se3 && !L3) {
      const e3 = bt * pt, t4 = e3 - pt;
      return Pt.slice(t4, e3);
    }
    return Pt;
  }, [bt, se3, L3, pt, Pt]), Ht = e2.useCallback((e3) => {
    yt(e3);
  }, []), Ft = e2.useCallback((e3) => {
    yt(e3);
  }, []), jt = e2.useCallback((e3) => {
    yt(e3);
  }, []), It = e2.useCallback((e3, t4) => Oe3(e3, t4), [Oe3]), Tt = e2.useCallback((e3, t4) => $e2(e3, t4), [$e2]), Lt = e2.useCallback((e3, t4) => Pe3(e3, t4), [Pe3]), Mt = e2.useCallback((e3, t4) => De3(e3, t4), [De3]), At = e2.useCallback((e3) => yt({ type: "CHANGE_PAGE", page: e3, paginationServer: L3, visibleOnly: E3, persistSelectedOnPageChange: vt }), [L3, vt, E3]), _t = e2.useCallback((e3) => {
    const t4 = c2(A2 || Dt.length, e3), n3 = g2(bt, t4);
    L3 || At(n3), yt({ type: "CHANGE_ROWS_PER_PAGE", page: n3, rowsPerPage: e3 });
  }, [bt, At, L3, A2, Dt.length]);
  if (se3 && !L3 && Pt.length > 0 && 0 === Dt.length) {
    const e3 = c2(Pt.length, pt), t4 = g2(bt, e3);
    At(t4);
  }
  Me2(() => {
    F3({ allSelected: ht, selectedCount: wt, selectedRows: mt.slice(0) });
  }, [Ct]), Me2(() => {
    ...
    if (!O3)
      return;
    const e3 = Pt.filter((e4) => O3(e4)), t4 = C3 ? e3.slice(0, 1) : e3;
    yt({ type: "SELECT_MULTIPLE_ROWS", keyField: d3, selectedRows: t4, totalRows: Pt.length, mergeSelections: St });
  }, [n2, O3]);
  const Nt = E3 ? Dt : Pt, zt = vt || C3 || S3;
  return e2.createElement(Le, { theme: $t }, !le3 && (!!i3 || !!s3) && e2.createElement(pe2, { title: i3, actions: s3, showMenu: !be3, selectedCount: wt, direction: et, contextActions: he3, contextComponent: Se3, contextMessage: me3 }), de3 && e2.createElement(we2, { align: ce3, wrapContent: ge3 }, ue3), e2.createElement(xe2, Object.assign({ $responsive: J3, $fixedHeader: re3, $fixedHeaderScrollHeight: ie3, className: nt }, kt), e2.createElement(ye2, null, Q3 && !Z3 && e2.createElement(Ce2, null, X3), e2.createElement(x2, Object.assign({ disabled: te3, className: "rdt_Table", role: "table" }, ot && { "aria-label": ot }), !oe3 && (!!Z3 || Pt.length > 0 && !Q3) && e2.createElement(y2, { className: "rdt_TableHead", role: "rowgroup", $fixedHeader: re3 }, e2.createElement(R2, { className: "rdt_TableHeadRow", role: "row", $dense: h2 }, f2 && (zt ? e2.createElement($2, { style: { flex: "0 0 48px" } }) : e2.createElement(ae2, { allSelected: ht, selectedRows: mt, selectableRowsComponent: P2, selectableRowsComponentProps: D3, selectableRowDisabled: k3, rowData: Nt, keyField: d3, mergeSelections: St, onSelectAllRows: Ft })), Ee3 && !Ne3 && e2.createElement(Re2, null), at.map((t4) => e2.createElement(ne2, { key: t4.id, column: t4, selectedColumn: ft, disabled: Q3 || 0 === Pt.length, pagination: se3, paginationServer: L3, persistSelectedOnSort: Rt, selectableRowsVisibleOnly: E3, sortDirection: xt, sortIcon: He3, sortServer: Ie3, onSort: Ht, onDragStart: rt, onDragOver: st, onDragEnd: ct, onDragEnter: it, onDragLeave: dt, draggingColumnId: lt })))), !Pt.length && !Q3 && e2.createElement(ve2, null, ee3), Q3 && Z3 && e2.createElement(Ce2, null, X3), !Q3 && Pt.length > 0 && e2.createElement(fe2, { className: "rdt_TableBody", role: "rowgroup" }, Dt.map((t4, n3) => {
    const o3 = r2(t4, d3), a2 = function(e3 = "") {
      return "number" != typeof e3 && (!e3 || 0 === e3.length);
    }(o3) ? n3 : o3, l3 = b2(t4, mt, d3), i4 = !!(Ee3 && Be3 && Be3(t4)), s4 = !!(Ee3 && _e3 && _e3(t4));
    return e2.createElement(q2, { id: a2, key: a2, keyField: d3, "data-row-id": a2, columns: at, row: t4, rowCount: Pt.length, rowIndex: n3, selectableRows: f2, expandableRows: Ee3, expandableIcon: j3, highlightOnHover: p2, pointerOnHover: m3, dense: h2, expandOnRowClicked: ze3, expandOnRowDoubleClicked: We2, expandableRowsComponent: Te3, expandableRowsComponentProps: Ae3, expandableRowsHideExpander: Ne3, defaultExpanderDisabled: s4, defaultExpanded: i4, expandableInheritConditionalStyles: Ge3, conditionalRowStyles: Je2, selected: l3, selectableRowsHighlight: v3, selectableRowsComponent: P2, selectableRowsComponentProps: D3, selectableRowDisabled: k3, selectableRowsSingle: C3, striped: u3, onRowExpandToggled: H3, onRowClicked: It, onRowDoubleClicked: Tt, onRowMouseEnter: Lt, onRowMouseLeave: Mt, onSelectedRow: jt, draggingColumnId: lt, onDragStart: rt, onDragOver: st, onDragEnd: ct, onDragEnter: it, onDragLeave: dt });
  }))))), Et && e2.createElement("div", null, e2.createElement(Ot, { onChangePage: At, onChangeRowsPerPage: _t, rowCount: A2 || Pt.length, currentPage: bt, rowsPerPage: pt, direction: et, paginationRowsPerPageOptions: W3, paginationIconLastPage: B3, paginationIconFirstPage: G3, paginationIconNext: V3, paginationIconPrevious: U3, paginationComponentOptions: K3 })));
});
export {
  G2 as Alignment,
  B2 as Direction,
